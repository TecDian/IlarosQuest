		...
		options = { 
			...
			args = {
				General = {
					...
					args = {
						...
						track = {
							...
							type = 'toggle',
							name = L["Track Zone"],
							desc = L["Track zone changes and update the IlarosQuest list for that zone"],
						...
						locallist = {
							...
							set = function(info, value) db[ info[#info] ] = value IlarosQuest:UpdateFrame() end,
						},
						locallist_help = {
							order = 5,
							type = "description",
						...
						purgeold = {
							...
							func = function()
								StaticPopup_Show ("ILAROSQUEST_PURGEOLD")
							end,
							order = -2,
						}
					},
				...
				Filters = {
					...
					set = function(info, value) dbpc.filters[ info[#info] ] = value IlarosQuest:UpdateFrame() end,
					args = {
						intro = {
							order = 1,
							type = "description",
						...
						UseableFilters = {
							...
							set = function(info, value) dbpc.enabledfilters[ info[#info] ] = value IlarosQuest:UpdateFrame() end,
							type = "group",
							order = 2,
							guiInline = true,
						...
						Status = {
							...
							args = {
								...
								example = {
									order = 7,
									type = "description",
									name = L["Example for Ignored quest: Some quests are still in the database but are not attainable ingame anymore. Ignore them to hide them from the list."],
									width = "double",
								},
							},
						},
						Level = {
							...
							args = {
								MinLevel = {
									...
									set = function(info, value) dbpc.filters[ info[#info] ] = value options.args.Filters.args.Level.args.MaxLevel.min = value IlarosQuest:UpdateFrame() end,
									min = 0,
									max = 80,
									step = 1,
									width = "double",
								...
								MaxLevel = {
									...
									set = function(info, value) dbpc.filters[ info[#info] ] = value options.args.Filters.args.Level.args.MinLevel.max = value IlarosQuest:UpdateFrame() end,
									min = 0,
									max = 80,
									step = 1,
									width = "double",
				...
				Sort = {
					...
					args = {
						...
						--[[UseableSorters = {
							...
							set = function(info, value) dbpc.enabledsort[ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							type = "group",
							order = 2,
							guiInline = true,
						...
						w = {
							...
							set = function(info, value) dbpc.sort["w"][ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							args = sortcommon,
						},
						d = {
							type = "group",
							...
							set = function(info, value) dbpc.sort["d"][ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							args = sortcommon,
						},
						t = {
							type = "group",
							...
							set = function(info, value) dbpc.sort["t"][ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							args = sortcommon,
						},
						l = {
							type = "group",
							...
							set = function(info, value) dbpc.sort["l"][ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							args = sortcommon,
						},
						n = {
							type = "group",
							...
							set = function(info, value) dbpc.sort["n"][ info[#info] ] = value IlarosQuest:UpdateSortList() IlarosQuest:UpdateFrame() end,
							args = sortcommon,
						},
					},
				},
...
local function optFunc() 
	...
	InterfaceOptionsFrame_OpenToCategory(addon.optionsFrames.IlarosQuest)
end
...
function addon:SetupOptions()
	...
	self.optionsFrames = {}
	--self.optionsFrames = {}
	--LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("IlarosQuest", options)
	--local ACD3 = LibStub("AceConfigDialog-3.0")
	--self.optionsFrames.IlarosQuest = ACD3:AddToBlizOptions("IlarosQuest", "IlarosQuest", nil, "General")
	
	-- setup options table Mapster
	LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("IlarosQuest", getOptions)
	self.optionsFrames.IlarosQuest = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("IlarosQuest", L["IlarosQuest"], nil, "General")
	self.optionsFrames.Filters = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("IlarosQuest", L["Filters"], "IlarosQuest", "Filters")
	self.optionsFrames.Sort = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("IlarosQuest", L["List Order"], "IlarosQuest", "Sort")
	--self:RegisterModuleOptions("Profiles", LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db), "Profiles")
	
	LibStub("AceConsole-3.0"):RegisterChatCommand( "ilarosquest", function() addon:Toggle() end)
	
	db = IlarosQuest.db.profile
	dbpc = IlarosQuest.dbpc.profile
end

function addon:RegisterModuleOptions(name, optionTbl, displayName)
	moduleOptions[name] = optionTbl
	LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("IlarosQuest: "..name, getOptions)
	self.optionsFrames[name] = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("IlarosQuest", displayName, "IlarosQuest", name)
end
