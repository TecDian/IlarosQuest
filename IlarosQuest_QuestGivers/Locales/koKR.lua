local L = LibStub("AceLocale-3.0"):NewLocale("IlarosQuest", "koKR")
...
L["Load Data from IlarosQuest database"] = "IlarosQuest 데이터를 불러옵니다."
L["Query the IlarosQuest database for quest names"] = "IlarosQuest 데이터에서 퀘스트 제목들 쿼리하기"
