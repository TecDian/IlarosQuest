...
-- L["WE"] = ""
-- L["Y"] = ""
-- L["You are running a source checkout of IlarosQuest %s directly from the repository."] = ""
-- L["You are running an ILAROS RELEASE of IlarosQuest %s (revision %d). If you'd like to improve it, contact the team!"] = ""
-- L["r%d"] = ""
...
L["IlarosQuest Log"] = "Registro de IlarosQuest"
L["Filters"] = "Filtros"
L["Options"] = "Opciones"
...
-- L["EQ_LOCALLIST"] = ""
-- L["Enable Filtering"] = ""
-- L["Example for Ignored quest: Some quests are still in the database but are not attainable ingame anymore. Ignore them to hide them from the list."] = ""
-- L["Faction Filter"] = ""
...
-- L["Status Filter"] = ""
-- L["Track Zone"] = ""
-- L["Track zone changes and update the IlarosQuest list for that zone"] = ""
-- L["Turned In Quests"] = ""
-- L["Type Filter"] = ""
-- L["Unknown Status"] = ""
-- L["Upgrade DB"] = ""
